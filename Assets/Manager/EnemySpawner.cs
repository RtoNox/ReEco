...
public class EnemySpawner : MonoBehaviour
{
    ...
    public float quantityIncreaseRate = 0.1f;
    public float maxQuantityMultiplier = 10f;
    public int baseEnemiesPerWave = 5;
    public float enemiesPerWaveIncrease = 0.3f;
